"""
Django settings for quiz_teacher project.
...
SECRET_KEY = 'django-insecure-e8-0(8z9vfd_-fsg^w0w__r60xqov$osp(vk+#4&0geaa4&ln+'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['deploy-test-123.herokuapp.com']
...
ROOT_URLCONF = 'quiz_teacher.urls'
...
WSGI_APPLICATION = 'quiz_teacher.wsgi.application'
